...
<input id='input-tag' placeholder='Pakistan'/><label htmlFor='input-tag'></label>
<div className='angle-down-div'><FontAwesomeIcon icon={faAngleDown} className='angle-down'/></div>
</div>

{/* 3 Search Bar Larger */}
<div className='serach-bar-larger'>
<input id='input-search' placeholder='Find Cars , Mobile Phones and more...'/><label htmlFor='input-search'></label>
